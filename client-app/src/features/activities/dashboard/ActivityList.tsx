                    ...
                    <Item key={activity.id}>
                        <Item.Content>
                            ...
                            <Item.Extra>
                                ...
                                <Button name={activity.id} loading={submitting && target===activity.id} floated='right' content='Delete' color='red' onClick={(e) => handleDeleteActivity(e, activity.id)}></Button>
